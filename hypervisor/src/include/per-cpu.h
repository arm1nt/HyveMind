...
#define percpu_ptr(_name, _cpu) ((void *) &(__percpu_##_name[_cpu]))
#define percpu_val(_name, _cpu) (__percpu_##_name[_cpu])

#define set_percpu_val(_name, _cpu, _val) (__percpu_##_name[_cpu] = (_val))
